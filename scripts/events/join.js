...
.then(response => {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    return api.sendMessage("চলে এসেছি আমি EMon-BHai-Bot তোমাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
ADMIN BOT : EMON HAWLADAR ( EMon-BHai )

🟣Facebook Account Link: 

https://www.facebook.com/EMon.BHai.FACEBOOK

🔵WHATSAPP NUMBER: wa.me/+8801309991724

🟢SUPPORT EMAIL: emonhawladar311@gmail.com
...
🟢SUPPORT EMAIL: mdmnnm2004@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
  }})
.catch(error => {
    console.error(error);
});
